...
public class EventAdapter extends RecyclerView.Adapter<EventAdapter.EventViewHolder> {
    ...
    public static class EventViewHolder extends RecyclerView.ViewHolder {
        ...
        Button editButton, deleteButton,viewCommenttButton;
        ...
        public EventViewHolder(@NonNull View itemView) {
            ...
            viewCommenttButton = itemView.findViewById(R.id.commentButton);
//            Button commentButton = findViewById(R.id.commentButton);  // Assuming you already have a button in your layout
//            commentButton.setOnClickListener(new View.OnClickListener() {
//                @Override
//                public void onClick(View view) {
//                    // Start the activity_main_1 class
