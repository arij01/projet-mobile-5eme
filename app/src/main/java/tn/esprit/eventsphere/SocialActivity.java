...
public class SocialActivity extends AppCompatActivity implements CommentAdapter.CommentActionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postButton.setOnClickListener(v -> {
            ...
            if (!commentText.isEmpty()) {
                ...
                Toast.makeText(SocialActivity.this, "Comment cannot be empty!", Toast.LENGTH_SHORT).show();
            }
        });
    }
